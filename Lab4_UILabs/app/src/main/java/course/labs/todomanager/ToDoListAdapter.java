...
public class ToDoListAdapter extends BaseAdapter {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		// TODO - caoth Display Title in TextView
		final TextView titleView = (TextView) itemLayout.findViewById(R.id.titleView);
		titleView.setText(toDoItem.getTitle());

		// TODO - caoth Set up Status CheckBox
		final CheckBox statusView = (CheckBox) itemLayout.findViewById(R.id.statusCheckBox);
		statusView.setChecked(toDoItem.getStatus() == ToDoItem.Status.DONE ? true : false);

		// TODO - caoth Must also set up an OnCheckedChangeListener,
		...
		// TODO - caoth Display Priority in a TextView
		...
		// TODO - caoth Display Time and Date.
	...
	public void swipeRight(int pos) {
		...
		Toast.makeText(mContext, "Right" + item.getTitle(), Toast.LENGTH_SHORT).show();
	}

	public void swipeLeft(int pos) {
		ToDoItem item = mItems.get(pos);
		Toast.makeText(mContext, "Left" + item.getTitle(), Toast.LENGTH_SHORT).show();
	}
}
