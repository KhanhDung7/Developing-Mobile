...
public class AddToDoActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		cancelButton.setOnClickListener(new OnClickListener() {
			@Override
			public void onClick(View v) {
				// TODO - caoth Indicate result and finish
				setResult(RESULT_CANCELED);
                finish();
			}
		});

		// TODO - caoth Set up OnClickListener for the Reset Button
		final Button resetButton = (Button) findViewById(R.id.resetButton);
		resetButton.setOnClickListener(new OnClickListener() {
			@Override
			public void onClick(View v) {
				// TODO - caoth Reset data to default values
                mTitleText.setText("");
		...
		submitButton.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				// TODO - caoth Get the current ToDoItem Title
				...
				// TODO - caoth return data Intent and finish
